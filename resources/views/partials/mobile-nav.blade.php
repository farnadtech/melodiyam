...
<nav id="mobile-bottom-nav"
     class="lg:hidden fixed bottom-0 inset-x-0 z-[90] bg-white/95 dark:bg-surface-900/95 backdrop-blur-xl border-t border-surface-200/50 dark:border-surface-800/50"
     style="padding-bottom: env(safe-area-inset-bottom, 0px); transition: transform 0.3s ease"
     x-data
>
