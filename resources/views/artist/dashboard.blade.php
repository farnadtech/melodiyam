...
<div class="p-4 lg:p-8 space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <a href="{{ route('artist.settings') }}" wire:navigate
           class="glass-card rounded-2xl p-5 flex items-center gap-4 hover:ring-2 hover:ring-surface-300 dark:hover:ring-surface-700 transition-all group">
            <div class="w-12 h-12 rounded-xl bg-surface-100 dark:bg-surface-800 flex items-center justify-center flex-shrink-0 group-hover:bg-surface-200 dark:group-hover:bg-surface-700 transition-colors">
                <svg class="w-6 h-6 text-surface-600 dark:text-surface-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            </div>
            <div>
                <p class="font-semibold text-surface-900 dark:text-white">تنظیمات پروفایل</p>
                <p class="text-xs text-surface-500 mt-0.5">ویرایش آواتار و بیوگرافی</p>
            </div>
        </a>
    </div>
