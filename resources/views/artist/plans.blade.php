...
<div class="p-4 lg:p-8 space-y-8 max-w-4xl mx-auto">
    ...
    <div class="glass-card rounded-2xl p-10 text-center text-surface-500">
        ...
        <a href="mailto:support@melodiyam.ir" class="mt-4 inline-block px-4 py-2 rounded-xl bg-primary-500 text-white text-sm font-medium hover:bg-primary-600 transition-colors">
            تماس با پشتیبانی
        </a>
    </div>
    @else
